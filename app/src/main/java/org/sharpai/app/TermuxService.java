...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/org.sharpai/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "org.sharpai.termux.service_stop";
    private static final String ACTION_LOCK_WAKE = "org.sharpai.termux.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "org.sharpai.termux.service_wake_unlock";
    /** Intent action to launch a new terminal session. Executed from TermuxWidgetProvider. */
    public static final String ACTION_EXECUTE = "org.sharpai.termux.service_execute";

    public static final String EXTRA_ARGUMENTS = "org.sharpai.termux.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "org.sharpai.termux.execute.cwd";
    public static final String EXTRA_EXECUTE_IN_BACKGROUND = "org.sharpai.termux.execute.background";
